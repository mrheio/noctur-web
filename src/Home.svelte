<script>
    ...
    import { Btn, Loading } from './common/components';
...
<Loading condition={isLoading}>
    <Fullpage>
        <FullpageSection>
            <div class="Home gray-overlay fullscreen centered">
                <div class="Home__wrapper">
                    <h1>Iechipele</h1>
                    <h3>Gaseste playeri, rapid si simplu</h3>

                    <div class="Home__wrapper__text">
                        <p>
                            Esti intr-o cautare disperata de oameni? Nu ai cu
                            cine sa te joci? Prietenii te-au abandonat?
                        </p>
                        <p>
                            Aici si acum poti sa te alaturi unor oameni alaturi
                            de care sa iti dai in cap.
                        </p>
                    </div>
        ...
        <FullpageSection>
            <div class="header-offset margin-inline--s">
                <h1>Echipe in cautare de playeri</h1>
                <TeamsList />
            </div>
        </FullpageSection>
    </Fullpage>
